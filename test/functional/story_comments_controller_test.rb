...
class StoryCommentsControllerTest < ActionController::TestCase
  ...
  test "should create story_comment" do
    assert_difference('StoryComment.count') do
      post :create, story_comment: { content: @story_comment.content, created_at: @story_comment.created_at, state: @story_comment.state, story_id: @story_comment.story_id, user_id: @story_comment.user_id }
    end
  ...
  test "should update story_comment" do
    put :update, id: @story_comment, story_comment: { content: @story_comment.content, created_at: @story_comment.created_at, state: @story_comment.state, story_id: @story_comment.story_id, user_id: @story_comment.user_id }
    assert_redirected_to story_comment_path(assigns(:story_comment))
  end
